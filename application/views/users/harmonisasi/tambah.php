                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <h4>Informasi Raperdas</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <input id="berita_acara" onchange="checkSelectedFileSpecial_notRequired(id)"
                                   type="file" name="berita_acara" class="form-control" >
                            <small class="lh-1" style="color: red"><i>.pdf .doc .docx (max size : 4 MB)</i></small>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <input id="surat_hasil" onchange="checkSelectedFileSpecial_notRequired(id)"
                                   type="file" name="surat_hasil" class="form-control" >
                            <small class="lh-1" style="color: red"><i>.pdf .doc .docx (max size : 4 MB)</i></small>
                        </div>
                    </div>
