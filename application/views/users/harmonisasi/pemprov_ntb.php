            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    <?php if ($_SESSION['level']!="perancang" && $_SESSION['level']!="pemda"){ ?>
                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/t.html"
                        ...
                        <?php } ?> >
                            <i class="fa fa-plus-circle"></i> Tambah Dokumensz
...
<!--                            'belum_diproses','perbaikan','draft_sedang_dibuat','menunggu_koreksi','selesai'-->
                            <!--'belum_diproses','perbaikan','draft_sedang_dibuat','menunggu_koreksi','selesai'-->
                            <select class="form-control default-select2" id="stt" onchange="window.location.href='harmonisasi/v2/pemprov_ntb/id/'+this.value;">
                        ...
                        <div class="col-md-1 hidden">
                            <button class="btn btn-default" onclick="window.location.href='harmonisasi/v2/pemprov_ntb/id/'+$('#stt').val();"><i class="fa fa-search"></i> Filter</button>
                        </div>
                            ...
                            foreach ($query->result() as $baris):?>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <?php if ($_SESSION['level']!="perancang" && $_SESSION['level']!="pemda"){ ?>
                                            <a href="<?php echo $link1; ?>/v/h/<?php echo hashids_encrypt($baris->id_berita); ?>/pemprov_ntb"
                                                <?php if ($_SESSION['nama_zona']=='superadmin') { ?>
