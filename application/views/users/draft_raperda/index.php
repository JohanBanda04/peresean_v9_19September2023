                ...
                <div class="panel-body">
                    <?php if ($_SESSION['level']!="perancang"){ ?>
                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?= $link3; ?>/t.html" class="btn btn-primary"><i
                                    class="fa fa-plus-circle"></i> Tambah Dokumensz</a>
                        <!--                            --><?//= $zona_document; ?>
...
<!--                            'belum_diproses','perbaikan','draft_sedang_dibuat','menunggu_koreksi','selesai'-->
                            <!--'belum_diproses','perbaikan','draft_sedang_dibuat','menunggu_koreksi','selesai'-->
                            <select class="form-control default-select2" id="stt" onchange="window.location.href='pemda/draft/<?= $link3?>/id/'+this.value;">
                            ...
                            foreach ($query->result() as $baris):?>
                                ...
                                <tr>
                                    ...
                                    <td ><?php if($baris->nama_perancang=="" || $baris->nama_perancang==null){ ?>
                                            <span>-</span>
                                        <?php } else { ?>
                                            <span><?= $baris->nama_perancang; ?></span>
                                        <?php } ?></td>
...
<!--                                        </a>-->
                                        ...
                                        <a title="Edit Kasub Perancang" href="pemda/draft/<?= $link3; ?>/ce_kasub_perancang/<?= hashids_encrypt($baris->id_draft_permohonan);?>"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-group col-lg-12" style="justify-items: end; background-color: ">
                                                        <div class="row m-l-1" style=" overflow: hidden;  ">
                                                            <a style="text-decoration: none" href="<?php echo base_url($baris->draft_harmonisasi);?>" target="_blank">
                                                                <i class="fa fa-check-square" style="margin-right: 15px"></i>
                                                    ...
                                                    <div class="form-group col-lg-12" style="justify-items: end; background-color: ">
                                                        <div class="row m-l-1" style=" overflow: hidden;  ">
                                                            <?php if ($baris->naskah_akademik_dll==null || $baris->naskah_akademik_dll=="") {
                                                                ...
                                                                <a style="text-decoration: none" href="<?php echo base_url($baris->naskah_akademik_dll);?>" target="_blank">
                                                                    <i class="fa fa-check-square" style="margin-right: 15px"></i>
